...
<body>
    ...
    <p>Индивидуальный предприниматель ' . ($project->client_company_name ?? str_repeat('_', 60)) . ', ИНН ' . ($project->client_inn ?? str_repeat('_', 30)) . ', в дальнейшем «Заказчик», с другой стороны, составили настоящий Акт о том, что Исполнитель выполнил следующие работы:</p>
    ...
    <table style="width: 100%; margin-top: 50px;">
        <tr>
            ...
            <td style="width: 50%; vertical-align: top;">
                <p><b>Заказчик:</b></p>
                <p>ИП ' . ($project->client_company_name ?? str_repeat('_', 60)) . '<br>
