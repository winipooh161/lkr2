...
class Project extends Model
{
    ...
    public function getFullPassportDataAttribute(): string
    {
        ...
        if ($this->passport_issued_date && $this->passport_issued_date instanceof \DateTime) {
            $passport .= ', дата выдачи: ' . $this->passport_issued_date->format('d.m.Y');
        } elseif ($this->passport_issued_date) {
            $passport .= ', дата выдачи: ' . $this->passport_issued_date;
        }
