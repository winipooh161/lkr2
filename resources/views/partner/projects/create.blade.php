                        ...
                        <div class="row">
                            <div class="col-md-6">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control @error('client_name') is-invalid @enderror" id="client_name" name="client_name" value="{{ old('client_name') }}" required maxlength="255">
                                    @error('client_name')
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control maskphone @error('phone') is-invalid @enderror" id="phone" name="phone" value="{{ old('phone') }}" required maxlength="20" pattern="\+?[0-9\s\-\(\)]{10,20}">
                                    @error('phone')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                ...
                                <div class="row">
                                    <div class="col-md-4 mb-3">
                                        ...
                                        <input type="text" class="form-control @error('passport_series') is-invalid @enderror" id="passport_series" name="passport_series" value="{{ old('passport_series') }}" placeholder="1234" maxlength="10">
                                    ...
                                    <div class="col-md-8 mb-3">
                                        ...
                                        <input type="text" class="form-control @error('passport_number') is-invalid @enderror" id="passport_number" name="passport_number" value="{{ old('passport_number') }}" placeholder="567890" maxlength="20">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6 mb-3">
                                        ...
                                        <input type="text" class="form-control @error('passport_code') is-invalid @enderror" id="passport_code" name="passport_code" value="{{ old('passport_code') }}" placeholder="123-456" maxlength="20">
                                        @error('passport_code')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                                    </div>
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control @error('client_birth_place') is-invalid @enderror" id="client_birth_place" name="client_birth_place" value="{{ old('client_birth_place') }}" placeholder="г. Москва" maxlength="300">
                                ...
                                <div class="row">
                                    <div class="col-md-6 mb-3">
                                        ...
                                        <input type="text" class="form-control @error('registration_postal_code') is-invalid @enderror" id="registration_postal_code" name="registration_postal_code" value="{{ old('registration_postal_code') }}" placeholder="123456" maxlength="10" pattern="[0-9]{6}">
                                    ...
                                    <div class="col-md-6 mb-3">
                                        ...
                                        <input type="text" class="form-control @error('registration_city') is-invalid @enderror" id="registration_city" name="registration_city" value="{{ old('registration_city') }}" placeholder="Москва" maxlength="100">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control @error('registration_street') is-invalid @enderror" id="registration_street" name="registration_street" value="{{ old('registration_street') }}" placeholder="ул. Тверская" maxlength="200">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="number" step="0.1" min="0" max="10000" class="form-control @error('area') is-invalid @enderror" id="area" name="area" value="{{ old('area') }}">
                                    @error('area')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="url" class="form-control @error('camera_link') is-invalid @enderror" id="camera_link" name="camera_link" value="{{ old('camera_link') }}" placeholder="https://..." maxlength="500">
                                    @error('camera_link')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="number" step="0.01" min="0" max="99999999.99" class="form-control bg-light" id="work_amount" name="work_amount" value="{{ old('work_amount') }}" readonly>
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="number" step="0.01" min="0" max="99999999.99" class="form-control bg-light" id="materials_amount" name="materials_amount" value="{{ old('materials_amount') }}" readonly>
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="hidden" id="total_amount" name="total_amount" value="{{ old('total_amount', 0) }}">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-12 mt-4">
                                <div class="alert alert-info">
                                    ...
                                    <strong>Информация:</strong> Убедитесь, что все обязательные поля заполнены корректно перед сохранением проекта.
                                </div>
