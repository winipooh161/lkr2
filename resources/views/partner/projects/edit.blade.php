                        ...
                        <div class="row">
                            <div class="col-md-6">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control @error('client_name') is-invalid @enderror" id="client_name" name="client_name" value="{{ old('client_name', $project->client_name) }}" required maxlength="255">
                                    @error('client_name')
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control maskphone @error('phone') is-invalid @enderror" id="phone" name="phone" value="{{ old('phone', $project->phone) }}" required maxlength="20" pattern="\+?[0-9\s\-\(\)]{10,20}">
                                    @error('phone')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                ...
                                <div class="row">
                                    <div class="col-md-4 mb-3">
                                        ...
                                        <input type="text" class="form-control @error('passport_series') is-invalid @enderror" id="passport_series" name="passport_series" value="{{ old('passport_series', $project->passport_series) }}" placeholder="1234" maxlength="10">
                                    ...
                                    <div class="col-md-8 mb-3">
                                        ...
                                        <input type="text" class="form-control @error('passport_number') is-invalid @enderror" id="passport_number" name="passport_number" value="{{ old('passport_number', $project->passport_number) }}" placeholder="567890" maxlength="20">
                                ...
                                <div class="mb-3">
                                    ...
                                    <textarea class="form-control @error('passport_issued_by') is-invalid @enderror" id="passport_issued_by" name="passport_issued_by" rows="2" placeholder="Отделом УФМС России по ..." maxlength="500">{{ old('passport_issued_by', $project->passport_issued_by) }}</textarea>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6 mb-3">
                                        ...
                                        <input type="text" class="form-control @error('passport_code') is-invalid @enderror" id="passport_code" name="passport_code" value="{{ old('passport_code', $project->passport_code) }}" placeholder="123-456" maxlength="20" pattern="[0-9]{3}-[0-9]{3}">
                                        @error('passport_code')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                                    </div>
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control @error('client_birth_place') is-invalid @enderror" id="client_birth_place" name="client_birth_place" value="{{ old('client_birth_place', $project->client_birth_place) }}" placeholder="г. Москва" maxlength="300">
                                ...
                                <div class="row">
                                    <div class="col-md-6 mb-3">
                                        ...
                                        <input type="text" class="form-control @error('registration_postal_code') is-invalid @enderror" id="registration_postal_code" name="registration_postal_code" value="{{ old('registration_postal_code', $project->registration_postal_code) }}" placeholder="123456" maxlength="10" pattern="[0-9]{6}">
                                    ...
                                    <div class="col-md-6 mb-3">
                                        ...
                                        <input type="text" class="form-control @error('registration_city') is-invalid @enderror" id="registration_city" name="registration_city" value="{{ old('registration_city', $project->registration_city) }}" placeholder="Москва" maxlength="100">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control @error('registration_street') is-invalid @enderror" id="registration_street" name="registration_street" value="{{ old('registration_street', $project->registration_street) }}" placeholder="ул. Тверская" maxlength="200">
                                ...
                                <div class="row">
                                    <div class="col-md-6 mb-3">
                                        ...
                                        <input type="text" class="form-control @error('registration_house') is-invalid @enderror" id="registration_house" name="registration_house" value="{{ old('registration_house', $project->registration_house) }}" placeholder="12" maxlength="20">
                                    ...
                                    <div class="col-md-6 mb-3">
                                        ...
                                        <input type="text" class="form-control @error('registration_apartment') is-invalid @enderror" id="registration_apartment" name="registration_apartment" value="{{ old('registration_apartment', $project->registration_apartment) }}" placeholder="45" maxlength="20">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="number" step="0.01" min="0" max="99999999.99" class="form-control bg-light" id="work_amount" name="work_amount" value="{{ old('work_amount', $project->work_amount) }}" readonly>
                                    <div class="form-text">Данные из основных смет объекта со статусом "Создана" (заполняется автоматически). Если несколько смет, их суммы складываются.</div>
                                </div>
                                
                                <div class="mb-3">
                                    <label for="materials_amount" class="form-label">Стоимость материалов, ₽</label>
                                    <input type="number" step="0.01" min="0" max="99999999.99" class="form-control bg-light" id="materials_amount" name="materials_amount" value="{{ old('materials_amount', $project->materials_amount) }}" readonly>
                                    <div class="form-text">Данные из смет материалов объекта со статусом "Создана" (заполняется автоматически). Если несколько смет материалов, их суммы складываются.</div>
                                </div>

                                <div class="mb-3">
                                    <label for="total_display" class="form-label">Общая стоимость, ₽</label>
                                    <input type="text" class="form-control bg-light" id="total_display" value="{{ number_format($project->total_amount, 2, ',', ' ') }} ₽" readonly>
                                    <input type="hidden" id="total_amount" name="total_amount" value="{{ old('total_amount', $project->total_amount) }}">
...
document.addEventListener("DOMContentLoaded", function () {
    ...
    function calculateTotal() {
        ...
        // Обновляем скрытое поле total_amount
    ...
    // В этих событиях нет необходимости, так как поля только для чтения
    // workAmountInput.addEventListener('input', calculateTotal);
    // materialsAmountInput.addEventListener('input', calculateTotal);

    // Управление табами
    const tabs = ['required', 'client', 'details', 'team', 'additional'];
    let currentTab = 0;
...
<!-- Подключаем модуль для автоматического обновления materials_amount -->
...
<script>
    // Устанавливаем ID проекта для использования в MaterialsAmountUpdater
