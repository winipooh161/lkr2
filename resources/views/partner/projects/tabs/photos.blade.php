            ...
            @foreach($project->getPhotoCategories() as $index => $category)
                <li class="nav-item" role="presentation">
                    <button class="nav-link {{ $index === 0 ? 'active' : '' }}" 
                            id="photo-category-tab-{{ $index }}"
                            data-bs-toggle="tab"
                            data-bs-target="#photo-category-content-{{ $index }}"
                            type="button"
                            role="tab"
                            aria-controls="photo-category-content-{{ $index }}"
        ...
        <div class="tab-content" id="photoCategoriesTabContent">
            @foreach($project->getPhotoCategories() as $index => $category)
                <div class="tab-pane fade {{ $index === 0 ? 'show active' : '' }}"
                     id="photo-category-content-{{ $index }}"
                     role="tabpanel"
                     aria-labelledby="photo-category-tab-{{ $index }}">
