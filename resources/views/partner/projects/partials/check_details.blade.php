    ...
    <div class="card mb-4">
        ...
        <div class="card-body">
            <div class="mb-3">
                ...
                <textarea class="form-control" id="comment{{ $check_id }}" rows="3" placeholder="Введите комментарий. Сохранение происходит автоматически.">{{ $details['comment'] ?? '' }}</textarea>
                <div class="form-text text-muted">
                    <small><i class="fas fa-info-circle me-1"></i> Комментарий сохраняется автоматически при вводе, потере фокуса или нажатии Ctrl+Enter</small>
                </div>
            </div>
        </div>
    </div>
