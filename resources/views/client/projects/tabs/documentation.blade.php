                                ...
                                <div class="card-body">
                                    ...
                                    <div class="d-flex justify-content-between">
                                        ...
                                        <div>
                                            ...
                                            @endif
                                            <a href="{{ $file->client_download_url }}" class="btn btn-sm btn-outline-primary" download>
                        ...
                        <div class="col file-item" data-file-id="{{ $file->id }}">
                            <div class="card h-100">
                                ...
                                <div class="card-footer">
                                    <a href="{{ $file->client_download_url }}" class="btn btn-sm btn-outline-primary w-100" download>
                                        <i class="fas fa-download me-1"></i>Скачать
                                    </a>
                                </div>
                            </div>
                ...
                <div class="documents-container">
                    <div class="row row-cols-1 row-cols-md-2 row-cols-lg-3 g-3 ">
                        @foreach($project->documentFiles as $file)
                            ...
                            <span class="badge bg-secondary">{{ $file->size_formatted }}</span>
                            @if($file->document_type === 'estimate')
                                @php
                                ...
                                @endphp
                                @if($estimateId)
                                    <a href="{{ route('client.estimates.download-pdf', $estimateId) }}" class="btn btn-sm btn-outline-primary">
                                        <i class="fas fa-download me-1"></i>Скачать
                                    </a>
                                @else
