<nav id="sidebar" class="sidebar">
    ...
    <ul class="list-unstyled components">
        <li class="{{ Request::is('/') ? 'active' : '' }}">
            <a href="{{ url('/') }}"><i class="fas fa-home me-2"></i>Главная</a>
        </li>
        ...
        @auth
            ...
            <li class="{{ Request::is('partner/estimates*') ? 'active' : '' }}">
                <a href="{{ route('partner.estimates.index') }}"><i class="fas fa-file-invoice me-2"></i>Сметы                     <span class="badge bg-warning text-dark ms-2" style="font-size: 0.7rem; vertical-align: super;">BETA</span></a>
            </li>
            ...
            <li class="{{ Request::is('estimator/estimates*') ? 'active' : '' }}">
                <a href="{{ route('estimator.estimates.index') }}"><i class="fas fa-file-invoice me-2"></i>Все сметы                     <span class="badge bg-warning text-dark ms-2" style="font-size: 0.7rem; vertical-align: super;">BETA</span></a>
            </li>
            <li class="nav-item">
