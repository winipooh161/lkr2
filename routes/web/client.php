...
Route::prefix('client')->name('client.')->middleware(['auth', 'admin.or.client'])->group(function () {
    ...
    // Маршрут для скачивания PDF смет
    Route::get('/estimates/{estimate}/download-pdf', [\App\Http\Controllers\Client\EstimateController::class, 'downloadPdf'])->name('estimates.download-pdf');
});
