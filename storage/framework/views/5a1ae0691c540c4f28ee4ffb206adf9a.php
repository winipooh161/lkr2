        ...
        try {
            ...
            if (!response.ok) {
                if (response.status === 404) {
                    ...
                    showAlert('danger', 'Пользователь с таким номером телефона не найден. Пожалуйста, зарегистрируйтесь.');
                    // Добавляем ссылку на регистрацию
                    loginAlert.innerHTML += '<div class="mt-2"><a href="<?php echo e(route("register")); ?>" class="btn btn-outline-primary btn-sm">Зарегистрироваться</a></div>';
                    
                    // Разблокируем кнопку для дальнейших попыток
