...
<div class="container-fluid">
    <!-- BETA Badge -->
    <div class="alert alert-warning border-0 mb-4" style="background: linear-gradient(135deg, #ff6b6b, #ffa500); color: white; border-radius: 10px; box-shadow: 0 4px 15px rgba(255, 107, 107, 0.3);">
        <div class="row align-items-center">
            <div class="col-auto">
                <div class="d-flex align-items-center justify-content-center" style="width: 50px; height: 50px; background: rgba(255, 255, 255, 0.2); border-radius: 50%; backdrop-filter: blur(10px);">
                    <i class="fas fa-flask" style="font-size: 24px;"></i>
                </div>
            </div>
            <div class="col">
                <h5 class="mb-1" style="font-weight: 700; text-shadow: 1px 1px 2px rgba(0,0,0,0.2);">
                    <i class="fas fa-exclamation-triangle me-2"></i>BETA-ВЕРСИЯ
                </h5>
                <p class="mb-0" style="opacity: 0.95; font-size: 0.95rem;">
                    Эта страница находится в стадии тестирования. Возможны неточности в расчетах. 
                    Пожалуйста, проверяйте результаты перед использованием в работе.
                </p>
            </div>
            <div class="col-auto">
                <span class="badge" style="background: rgba(255, 255, 255, 0.3); color: white; font-size: 0.8rem; padding: 8px 12px; border-radius: 20px; backdrop-filter: blur(10px);">
                    v0.1 Beta
                </span>
            </div>
        </div>
...
function initializeCalculator() {
    ...
    document.getElementById('export-pdf').addEventListener('click', function() {
        ...
        // Добавляем актуальные цены материалов
        Object.keys(materialPrices).forEach(materialId => {
            const priceInput = document.createElement('input');
            priceInput.type = 'hidden';
            priceInput.name = `prices[${materialId}]`;
            priceInput.value = materialPrices[materialId];
            exportForm.appendChild(priceInput);
        });
...
@media (max-width: 768px) {
    ...
    /* Адаптивность бета-баннера для мобильных */
    .alert.alert-warning {
        margin-left: -15px;
        margin-right: -15px;
