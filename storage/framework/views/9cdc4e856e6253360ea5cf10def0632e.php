...
unset($__errorArgs, $__bag); ?>" id="project_id" name="project_id" style="width: 100%;" data-placeholder="Выберите объект">
                                ...
                                <?php $__currentLoopData = $projects; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $project): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <option value="<?php echo e($project->id); ?>" <?php echo e(old('project_id') == $project->id ? 'selected' : ''); ?>>
                                        <?php echo e($project->client_name); ?> (<?php echo e($project->full_address); ?>)
                                    </option>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                            </select>
...
unset($__errorArgs, $__bag); ?>" id="type" name="type" required>
                                <?php $__currentLoopData = $templateTypes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $typeKey => $typeName): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <option value="<?php echo e($typeKey); ?>" <?php echo e(old('type', 'main') == $typeKey ? 'selected' : ''); ?>><?php echo e($typeName); ?></option>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                            </select>
...
<link href="<?php echo e(asset('css/estimates/enhanced-formula-system.css')); ?>?v=<?php echo e(time()); ?>" rel="stylesheet">

<!-- 1. HTTP клиент (базовая зависимость) -->
<script src="<?php echo e(asset('js/http-client-adapter.js')); ?>?v=<?php echo e(time()); ?>"></script>

<!-- 2. Унифицированная система формул -->
<script src="<?php echo e(asset('js/estimates/unified-formula-system.js')); ?>?v=<?php echo e(time()); ?>"></script>

<!-- 3. Расширенный калькулятор формул -->
<script src="<?php echo e(asset('js/estimates/enhanced-formula-calculator.js')); ?>?v=<?php echo e(time()); ?>"></script>

<!-- 4. Монитор состояния формул -->
<script src="<?php echo e(asset('js/estimates/formula-status-monitor.js')); ?>?v=<?php echo e(time()); ?>"></script>

<!-- 5. Полнофункциональный редактор с формулами -->
<script src="<?php echo e(asset('js/estimates/json-table-editor.js')); ?>?v=<?php echo e(time()); ?>"></script>

<!-- 6. Автосохранение -->
<script src="<?php echo e(asset('js/estimates/estimate-auto-saver.js')); ?>?v=<?php echo e(time()); ?>"></script>

<!-- 7. Основное ядро системы смет -->
<script src="<?php echo e(asset('js/estimates/estimates-core.js')); ?>?v=<?php echo e(time()); ?>"></script>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    // Инициализация системы формул
    if (typeof window.enhancedFormulaCalculator !== 'undefined') {
        console.log('✅ Инициализация расширенного калькулятора формул');
        
        // Установка обработчика для пересчета формул после изменения данных
        document.addEventListener('json-table-editor-data-changed', function(event) {
            console.log('🔄 Пересчет формул после изменения данных');
            if (window.enhancedFormulaCalculator) {
                window.enhancedFormulaCalculator.recalculateAll(event.detail?.data || null);
            }
        });
        
        // Показываем статус формул при необходимости
