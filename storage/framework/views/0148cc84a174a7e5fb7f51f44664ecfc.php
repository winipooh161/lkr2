...
<?php $__env->startSection('head'); ?>
    ...
    <link href="<?php echo e(asset('css/estimates/estimate-editor.css')); ?>?v=<?php echo e(time()); ?>" rel="stylesheet">
    <link href="<?php echo e(asset('css/estimates/estimates-export.css')); ?>?v=<?php echo e(time()); ?>" rel="stylesheet">
    <meta name="csrf-token" content="<?php echo e(csrf_token()); ?>">
    <meta name="estimate-id" content="<?php echo e($estimate->id); ?>">
    <meta name="estimate-type" content="<?php echo e($estimate->type ?? 'main'); ?>">
    
    <!-- Улучшения интерфейса экспорта -->
    <script src="<?php echo e(asset('js/estimates/export-ui-enhancements.js')); ?>?v=<?php echo e(time()); ?>"></script>
    
    <script>
        // Глобальные переменные для работы редактора
        window.estimateId = <?php echo e($estimate->id); ?>;
        window.estimateType = "<?php echo e($estimate->type ?? 'main'); ?>";
    </script>
                    ...
                    <ul class="dropdown-menu dropdown-menu-end" style="min-width: 280px;">
                        ...
                        <li>
                            <div class="px-3 py-2 export-section">
                                ...
                                <div class="d-flex gap-2 btn-group">
                                    <a class="btn btn-outline-success btn-sm flex-fill" href="<?php echo e(route('partner.estimates.export', $estimate->id)); ?>">
                                        <i class="fas fa-file-excel me-1"></i>Excel
                                    </a>
                                    <a class="btn btn-outline-danger btn-sm flex-fill" href="<?php echo e(route('partner.estimates.exportPdf', $estimate->id)); ?>">
                        ...
                        <li>
                            <div class="px-3 py-2 export-section">
                                ...
                                <div class="d-flex gap-2 btn-group">
                                    <a class="btn btn-outline-success btn-sm flex-fill" href="<?php echo e(route('partner.estimates.exportClient', $estimate->id)); ?>">
                                        <i class="fas fa-file-excel me-1"></i>Excel
                                    </a>
                                    <a class="btn btn-outline-danger btn-sm flex-fill" href="<?php echo e(route('partner.estimates.exportPdfClient', $estimate->id)); ?>">
                                        <i class="fas fa-file-pdf me-1"></i>PDF
                                    </a>
                        ...
                        <li>
                            <div class="px-3 py-2 export-section">
                                ...
                                <div class="d-flex gap-2 btn-group">
                                    <a class="btn btn-outline-success btn-sm flex-fill" href="<?php echo e(route('partner.estimates.exportContractor', $estimate->id)); ?>">
                                        <i class="fas fa-file-excel me-1"></i>Excel
                                    </a>
                                    <a class="btn btn-outline-danger btn-sm flex-fill" href="<?php echo e(route('partner.estimates.exportPdfContractor', $estimate->id)); ?>">
                                        <i class="fas fa-file-pdf me-1"></i>PDF
                                    </a>
                                </div>
                            </div>
        ...
        <div class="col-md-12">
            <div class="card mb-4">
                <div class="card-header d-flex justify-content-between align-items-center">
                    <div>
                        <h5 class="mb-0"><?php echo e($estimate->name ?? 'Новая смета'); ?></h5>
                        <?php if(isset($estimate) && $estimate->project): ?>
                            <span class="text-muted"><?php echo e($estimate->project->full_address); ?></span>
                        <?php endif; ?>
                    </div>
                </div>
                ...
                <div class="card-body p-0">
                    ...
                    <div id="estimate-editor-container" class="estimate-editor-container"
                         data-estimate-id="<?php echo e($estimate->id ?? ''); ?>"
                         data-template-type="<?php echo e($estimate->type ?? 'main'); ?>"
                         data-mode="edit">
...
<script>
    ...
    document.addEventListener('click', function(e) {
        if (e.target && e.target.id === 'create-client-pdf') {
            ...
            const estimateId = <?php echo e($estimate->id ?? 0); ?>;
...
<script src="<?php echo e(asset('js/http-client-adapter.js')); ?>?v=<?php echo e(time()); ?>"></script>

<!-- Основные скрипты редактора смет -->
<script src="<?php echo e(asset('js/estimates/estimate-editor-core.js')); ?>?v=<?php echo e(time()); ?>"></script>
<script src="<?php echo e(asset('js/estimates/estimate-editor-ui.js')); ?>?v=<?php echo e(time()); ?>"></script>
<script src="<?php echo e(asset('js/estimates/estimate-editor-formulas.js')); ?>?v=<?php echo e(time()); ?>"></script>

<script src="<?php echo e(asset('js/estimates/editor-action-patches.js')); ?>?v=<?php echo e(time()); ?>"></script>

<!-- Дополнительные расширения -->
<script src="<?php echo e(asset('js/estimates/estimate-editor-extended.js')); ?>?v=<?php echo e(time()); ?>"></script>
...
<script src="<?php echo e(asset('js/estimates/estimate-diagnostic.js')); ?>?v=<?php echo e(time()); ?>"></script>
...
<script src="<?php echo e(asset('js/estimates/estimates-export.js')); ?>?v=<?php echo e(time()); ?>"></script>
