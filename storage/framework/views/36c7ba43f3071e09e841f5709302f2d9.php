    ...
    <div class="card">
        <div class="card-header d-flex justify-content-between align-items-center">
            <h5 class="mb-0">
                ...
                <span class="badge bg-secondary ms-2"><?php echo e($estimates->total()); ?></span>
            </h5>
...
<?php if(config('app.debug')): ?>
<script src="<?php echo e(asset('js/estimates/test-export-guide.js')); ?>?v=<?php echo e(time()); ?>"></script>
<?php endif; ?>
<?php $__env->stopPush(); ?>
