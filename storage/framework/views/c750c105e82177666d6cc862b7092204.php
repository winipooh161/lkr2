...
<link href="<?php echo e(asset('css/modal-fixes-project.css')); ?>?v=<?php echo e(time()); ?>" rel="stylesheet">
<link href="<?php echo e(asset('css/modal-form-fixes.css')); ?>?v=<?php echo e(time()); ?>" rel="stylesheet">
<?php $__env->stopPush(); ?>
...
<script src="<?php echo e(asset('js/global-upload-loader.js')); ?>?v=<?php echo e(time()); ?>"></script>

<!-- JavaScript для исправления модальных окон в проектах -->
<script src="<?php echo e(asset('js/project-modal-fixes.js')); ?>?v=<?php echo e(time()); ?>"></script>
<!-- ЕДИНСТВЕННЫЙ скрипт для загрузки файлов -->
<script src="<?php echo e(asset('js/single-file-upload.js')); ?>?v=<?php echo e(time()); ?>"></script>
<!-- Исправление для работы с вложенными вкладками -->
<script src="<?php echo e(asset('js/nested-tabs-fix.js')); ?>?v=<?php echo e(time()); ?>"></script>
<!-- Специальное исправление для категорий фото -->
<script src="<?php echo e(asset('js/photo-categories-fix.js')); ?>?v=<?php echo e(time()); ?>"></script>
<!-- Отключаем все остальные обработчики загрузки файлов -->
<!-- <script src="<?php echo e(asset('js/modal-form-fix.js')); ?>?v=<?php echo e(time()); ?>"></script> -->
<!-- <script src="<?php echo e(asset('js/modal-form-fix-new.js')); ?>?v=<?php echo e(time()); ?>"></script> -->
<!-- <script src="<?php echo e(asset('js/project-file-handler.js')); ?>?v=<?php echo e(time()); ?>"></script> -->
<script>
    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        <?php if(session('open_tab')): ?>
            // Находим нужную вкладку и активируем её
            const tabId = '<?php echo e(session('open_tab')); ?>';
        ...
        <div class="d-flex flex-column flex-md-row justify-content-between align-items-start mb-2">
            <div>
                ...
                <p class="text-muted mb-2">
                    ...
                    <span class="d-block d-md-inline mt-1 mt-md-0 ms-md-2"><?php echo e($project->full_address); ?></span>
                </p>
            </div>
