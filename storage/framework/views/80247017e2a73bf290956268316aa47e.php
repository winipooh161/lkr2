                ...
                <td>
                    <?php if($estimate->project): ?>
                        <a href="<?php echo e(route('partner.projects.show', $estimate->project)); ?>" class="text-decoration-none">
                            <?php echo e($estimate->project->full_address); ?>
                ...
                <td>
                    <div class="dropdown estimate-action-dropdown">
                        ...
                        <ul class="dropdown-menu dropdown-menu-end">
                            ...
                            <li>
                                <a class="dropdown-item" href="<?php echo e(route('partner.estimates.editor', $estimate->id)); ?>">
                                ...
                                <div class="px-3 py-2 export-section">
                                    ...
                                    <div class="d-flex gap-2">
                                        <a class="btn btn-outline-success btn-sm flex-fill" 
                                           href="<?php echo e(route('partner.estimates.export', $estimate->id)); ?>"
                                           title="Скачать Excel с полными данными">
                                            <i class="fas fa-file-excel me-1"></i>Excel
                                        </a>
                                        <a class="btn btn-outline-danger btn-sm flex-fill" 
                                           href="<?php echo e(route('partner.estimates.exportPdf', $estimate->id)); ?>"
                            ...
                            <li>
                                <div class="px-3 py-2 export-section">
                                    ...
                                    <div class="d-flex gap-2">
                                        <a class="btn btn-outline-success btn-sm flex-fill" 
                                           href="<?php echo e(route('partner.estimates.exportClient', $estimate->id)); ?>"
                                           title="Скачать Excel для заказчика">
                                            <i class="fas fa-file-excel me-1"></i>Excel
                                        </a>
                                        <a class="btn btn-outline-danger btn-sm flex-fill" 
                                           href="<?php echo e(route('partner.estimates.exportPdfClient', $estimate->id)); ?>"
                            ...
                            <li>
                                <div class="px-3 py-2 export-section">
                                    ...
                                    <div class="d-flex gap-2">
                                        <a class="btn btn-outline-success btn-sm flex-fill" 
                                           href="<?php echo e(route('partner.estimates.exportContractor', $estimate->id)); ?>"
                                           title="Скачать Excel для мастера">
                                            <i class="fas fa-file-excel me-1"></i>Excel
                                        </a>
                                        <a class="btn btn-outline-danger btn-sm flex-fill" 
                                           href="<?php echo e(route('partner.estimates.exportPdfContractor', $estimate->id)); ?>"
